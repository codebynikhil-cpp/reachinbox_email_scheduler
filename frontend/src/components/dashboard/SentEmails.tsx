...
import { SentEmailTable, Pagination } from './EmailTable';
...
export function SentEmails({ refreshKey = 0 }: SentEmailsProps) {
  const [page, setPage] = useState(1);
  const { data, pagination, loading, error, fetch } = useSentEmails();
    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <h2 className="text-base font-semibold text-[var(--text-primary)]">Sent Emails</h2>
